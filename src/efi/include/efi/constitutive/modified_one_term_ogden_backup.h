...
private:
    ...
    // Cached global growth/load coefficient from the most recent constitutive
    // evaluation. The VTU postprocessor uses it to reconstruct Fe from
    // F_total so that the written stresses are based on Fe only.
